  ...
  return (
    <div className="pt-8 pb-14 bg-[#f4e2e2]">
      <div className="w-[68%] flex justify-between m-auto">
        <p className="text-[22px] font-[500px] leading-[32px] ">Recent Post</p>
      ...
      <div className="grid grid-cols-1 mt-5 md:grid-cols-2 gap-9 items-center w-[68%] mx-auto">
        <div className="bg-white px-8 pr-10 py-9 ">
          ...
          <p className="mt-6 mb-4 leading-[23.5px] text-[#21243D] font-[400]">
            ...
            Corporis, ad molestiae voluptas autem consequatur itaque
            totam numquam vel, reprehenderit deserunt consectetur
            voluptatibus, aspernatur nihil vitae.
          </p>
        </div>
        <div className="bg-white px-8 pr-10 py-9 ">
          <h2 className="text-[26px] font-[700] leading-[38px]">
          ...
          <p className="mt-6 leading-[23.5px] mb-4 text-[#21243D] font-[400]">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit.
            Earum tenetur ad magnam beatae quia, molestiae vitae 
            assumenda laborum molestias porro sed similique ab 
            praesentium quasi.
          </p>
        </div>
      </div>
